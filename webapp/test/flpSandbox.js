		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "Temporary Id Creation",
									"targetURL": "#vcpappvcptempidcreation-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"vcpappvcptempidcreation-display": {
								"semanticObject": "vcpappvcptempidcreation",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=vcpapp.vcptempidcreation",
									"url": sap.ui.require.toUrl("vcpapp/vcptempidcreation")
								}
							}
						}
					}
